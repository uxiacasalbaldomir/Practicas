    ...
    tabItems(
      tabItem(tabName= "welcome",   
              fluidRow(
                column(12, offset=0,
                h2("Welcome!"),
                    p("Please read the documentation in order to proceed.")#,
                    #HTML ('<iframe src=\"https://docs.google.com/document/d/e/2PACX-1vTz8a6M88X4Citm0HpaAH19XiOa_A7E8vSiG9VSNWH9qxCUcBhN8DNEcPoq60J5oWT-AYGakc20QJfU/pub\"></iframe>')
                #    ) # close box
                ) # close column
              ) # close fluidrow
      ...
      tabItem(tabName= "input",   
              fluidRow(
                ...
                box(title = "Load the files", color = "teal", solidHeader = TRUE,
                # FileQC
                fileInput("qc","Quality stats",placeholder="Please upload QC.txt"),
                # FilePreSeq
